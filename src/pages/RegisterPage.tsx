      ...
      <main className="mx-auto flex min-h-[80vh] max-w-lg flex-col justify-center px-4 py-8 md:px-6">
        ...
        <div className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-xl sm:p-8 space-y-6">
          <div className="text-center">
            ...
            <p className="mt-1 text-xs font-semibold text-slate-500 dark:text-slate-400">Join TheDecorParty for party setups and order tracking</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                <label className="text-xs font-extrabold uppercase text-slate-400">First Name *</label>
                <div className="relative mt-1">
                  ...
                  <input
                    ...
                    placeholder="John"
                    className="w-full rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/90 pl-10 pr-3 py-2.5 text-xs font-semibold text-slate-900 dark:text-white outline-none focus:border-brand-purple dark:focus:border-purple-400"
                  />
                </div>
                {errors.firstName && <p className="mt-1 text-[11px] font-bold text-rose-500">{errors.firstName}</p>}
              </div>

              <div>
                <label className="text-xs font-extrabold uppercase text-slate-400">Last Name</label>
                <div className="relative mt-1">
                  <User size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400" />
                  <input
                    type="text"
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/90 pl-10 pr-4 py-2.5 text-xs font-semibold text-slate-900 dark:text-white outline-none focus:border-brand-purple dark:focus:border-purple-400"
                />
              </div>
            ...
            <div>
              <label className="text-xs font-extrabold uppercase text-slate-400">Mobile Number (Optional)</label>
              <div className="relative mt-1">
              ...
              {errors.mobile && <p className="mt-1 text-[11px] font-bold text-rose-500">{errors.mobile}</p>}
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <div className="relative mt-1">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/90 pl-10 pr-10 py-2.5 text-xs font-semibold text-slate-900 dark:text-white outline-none focus:border-brand-purple dark:focus:border-purple-400"
                  />
                  <button
                    type="button"
              ...
              <div>
                <label className="text-xs font-extrabold uppercase text-slate-400">Confirm Password *</label>
                <div className="relative mt-1">
                  <Lock size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400" />
                  <input
                    type={showPassword ? 'text' : 'password'}
                ...
                {errors.confirmPassword && <p className="mt-1 text-[11px] font-bold text-rose-500">{errors.confirmPassword}</p>}
              </div>
            </div>
          ...
          <div className="text-center text-xs font-semibold text-slate-500 dark:text-slate-400 pt-2 border-t border-slate-100 dark:border-slate-800">
            ...
            <Link to="/login" className="font-bold text-brand-purple dark:text-purple-400 hover:underline">
              Sign In
            </Link>
          </div>
        </div>
